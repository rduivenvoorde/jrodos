...
<qgis version="2.14.14-Essen" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e7991823-286e-4757-abcb-af6991a87fb7}">
      <rule description="Abstract" filter="unitvalue &lt;= 0.1" key="{bd7e31b7-fd0a-41d4-9f3f-354edaa4ee63}" symbol="0" label="&lt;= 1E-1 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 0.1 AND unitvalue &lt;= 1" key="{0d506bed-7e29-4951-8dd6-950f7450eec1}" symbol="1" label="1E-1 - 1 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 1 AND unitvalue &lt;= 10" key="{8071164e-e3dc-4aab-86ea-e5bf80fb8a64}" symbol="2" label="1 - 10 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 10 AND unitvalue &lt;= 100" key="{6763d8b5-1b32-4621-a388-498ec613aba3}" symbol="3" label="10 - 100 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 100 AND unitvalue &lt;= 1000" key="{41bc24bd-294c-4818-ae41-17744878653f}" symbol="4" label="100 - 1000 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 1000 AND unitvalue &lt;= 10000" key="{a26143cf-f0d8-4a5c-8ebb-e31e5d3ece27}" symbol="5" label="1000 - 10000 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 10000 AND unitvalue &lt;= 100000" key="{dc24e19b-9919-4eed-9b5b-d5a7b3e6d3f7}" symbol="6" label="10000 - 100000 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 100000 AND unitvalue &lt;= 1000000" key="{b2906596-36e6-4582-b813-885480ddf6ab}" symbol="7" label="100000 - 1000000 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 1000000 AND unitvalue &lt;= 10000000" key="{4147d8ff-4b6e-4dfe-a935-474d1c1f9572}" symbol="8" label="1000000 - 10000000 USV/H"/>
      <rule description="Abstract" filter="unitvalue >= 10000000" key="{54a5d065-9ab5-4c17-ae53-6686d5b0a354}" symbol="9" label=">10000000 USV/H"/>
    </rules>
    <symbols>
